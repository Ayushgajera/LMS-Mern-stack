...
import { FiSearch, FiBookOpen, FiGrid, FiUser, FiBell, FiLogOut, FiEdit2, FiSettings, FiHome, FiDollarSign } from 'react-icons/fi';
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-500">
                  {userData?.role ? (
                    <span className="inline-block px-2 py-0.5 rounded bg-emerald-100 text-emerald-700 font-semibold">
                ...
                >
                  ...
                  <div className="px-4 py-3">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-base text-lg font-semibold text-gray-800">{userData?.name || 'Guest'}</h4>
                        <p className="text-sm text-gray-500">{userData?.email || 'Guest'}</p>
                        <div className="mt-2">
                          <div className="flex items-center justify-between text-xs text-gray-500 mb-1">
                            <span className='text-[14px] font-medium text-black'>{userData?.role}</span>
                          </div>
                  ...
                  <div className="grid grid-cols-3 gap-1 px-3 ">
                    ...
                    <div className="flex flex-col items-center p-2 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer">
                      ...
                      <p className="text-md font-semibold text-gray-800">$4500</p>
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden  md:flex items-center justify-between ml-8 space-x-1">
              ...
              <button onClick={handleBecomeStudent} className="block  text-emerald-700 text-center px-4 py-2 border-2 border-emerald-500 font-bold text-md rounded-lg hover:bg-emerald-100 border-emerald  transition">
                Become a Student
              </button>
