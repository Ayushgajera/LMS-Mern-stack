          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Welcome back, <span className="font-semibold text-gray-800">{userData?.user?.name || 'Admin'}</span>! 
            ...
            >
              ...
              <div className="relative">
                ...
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{card.value}</p>
