...
import { FiHome, FiBook, FiMenu, FiX, FiUsers, FiDollarSign } from 'react-icons/fi';
...
function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex h-screen w-64 flex-col fixed left-0 top-0 bottom-0 bg-white border-r border-gray-200 z-30 shadow-xl">
        {/* Logo */}
