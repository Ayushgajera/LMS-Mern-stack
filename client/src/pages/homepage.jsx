        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {categories.map((category) => (
              <div key={category.id} className="group bg-white rounded-xl shadow-lg p-6 text-center hover:bg-blue-50 transition duration-300 cursor-pointer animate-fade-in">
