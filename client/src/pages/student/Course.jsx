...
function Course({ course, isPurchased }) {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="p-5 pt-2 space-y-2 min-h-[210px] flex flex-col justify-between">
        {/* Subtitle above Title */}

        <h3 className="font-bold text-lg text-gray-800 mb-1 line-clamp-2 hover:text-emerald-600 transition-colors duration-200 overflow-hidden text-ellipsis">
          {course.courseTitle}
        </h3>
        <p className="text-sm text-gray-600 line-clamp-1 overflow-hidden text-ellipsis">{course.subTitle}</p>
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <div>
            <p className="text-sm font-medium text-gray-800">{course.creator?.name || 'Instructor'}</p>
