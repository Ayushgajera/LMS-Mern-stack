...
function ExplorePage() {
  ...
  const { data, isLoading, error } = useGetPublishCourseQuery();
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="animate-pulse">
            ...
            {/* Search Skeleton */}
            <div className="h-14 bg-gray-200 rounded-xl w-full mb-8"></div>
            
            {/* Cards Skeleton */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {[...Array(8)].map((_, i) => (
                <div key={i} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 space-y-4 border border-white/20">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 pt-20">
      {/* Header Section */}
      <div className="bg-white/80 backdrop-blur-xl border-b border-white/20 sticky top-16 z-40">
            ...
            <div className="relative flex-1 max-w-lg">
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 border border-gray-200/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/80 backdrop-blur-sm transition-all duration-200 group-hover:bg-white/90"
                />
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          >
            ...
            <motion.button
              ...
              className="flex items-center gap-2 px-4 py-2.5 border border-gray-200/50 rounded-xl hover:bg-gray-50/50 transition-all duration-200 bg-white/80 backdrop-blur-sm"
            ...
            {activeFiltersCount > 0 && (
              <motion.button
                ...
                className="flex items-center gap-1 px-3 py-1.5 bg-red-100 text-red-600 rounded-full text-sm hover:bg-red-200 transition-all duration-200 font-medium"
            ...
            <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-xl p-1 border border-gray-200/50">
              <motion.button
                ...
                className={`p-2 rounded-lg transition-all duration-200 ${viewMode === 'grid' ? 'bg-blue-500 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'}`}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
              ...
              <motion.button
                ...
                className={`p-2 rounded-lg transition-all duration-200 ${viewMode === 'list' ? 'bg-blue-500 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'}`}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-gray-200/50 rounded-xl focus:ring-2 focus:ring-blue-500 bg-white/80 backdrop-blur-sm transition-all duration-200"
                    >
