      ...
      {statItems.map((stat, index) => {
        ...
        return (
          <motion.div
            ...
            className="bg-white p-6 rounded-lg border hover:shadow-lg transition-shadow duration-200"
          >
          ...
          {activeTab === 'courses' && (
            <div className="grid gap-6">
              {user?.enrolledCourses?.length > 0 ? (
                ...
                <div className="text-center text-gray-600 p-8 bg-white rounded-lg border">
